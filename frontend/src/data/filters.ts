...
export const FILTER_DEFINITIONS: FilterDefinition[] = [
  ...
  { id: "volatility", label: "Volatility 3Y", type: "range", category: "risk" },
  { id: "downside_deviation", label: "Downside Deviation 3Y", type: "range", category: "risk" },
  { id: "skewness", label: "Skewness 3Y", type: "range", category: "risk" },
  { id: "kurtosis", label: "Kurtosis 3Y", type: "range", category: "risk" },

  { id: "sharpe", label: "Sharpe Ratio 3Y", type: "range", category: "ratios" },
  { id: "sortino", label: "Sortino Ratio 3Y", type: "range", category: "ratios" },
  { id: "calmar", label: "Calmar Ratio 3Y", type: "range", category: "ratios" },
  { id: "pain_index", label: "Pain Ratio 3Y", type: "range", category: "ratios" },
  { id: "ulcer_index", label: "Ulcer Ratio 3Y", type: "range", category: "ratios" },
