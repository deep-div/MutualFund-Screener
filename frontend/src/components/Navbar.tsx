...
import { Search, ChevronDown, LogOut, User, Bookmark, LayoutTemplate, ListChecks, Trash2, Check, SlidersHorizontal, BookOpen, TrendingUp, Percent, PiggyBank } from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        <Link
          to="/"
          className="flex shrink-0 items-center gap-1.5 text-base font-bold tracking-tight text-nav-foreground sm:text-lg lg:w-[140px]"
        >
          <img src="/logo.png" alt="FundScreener logo" className="w-9 h-6" />
        ...
        <div className="order-3 flex w-full flex-row items-center gap-2 sm:gap-3 lg:order-none lg:flex-1 lg:justify-center lg:gap-8">
          ...
          {/* SEARCH */}
          <div ref={searchRef} className="relative z-[80] flex-1 min-w-0 lg:max-w-md">
            <div
          ...
          <div className="block shrink-0">
            ...
            >
              <DropdownMenuTrigger asChild>
                <button
                  className={`inline-flex min-h-10 items-center gap-1.5 whitespace-nowrap rounded-xl px-3 py-2.5 text-[13px] font-medium text-white outline-none transition-colors focus:outline-none focus-visible:outline-none focus-visible:ring-0 sm:px-3 sm:text-[14px] lg:px-4 lg:text-[14px] ${
                    moreMenuOpen
                      ? "bg-nav-hover text-white"
                      : "hover:bg-nav-hover/80 hover:text-white active:bg-nav-hover active:text-white"
                  }`}
              ...
              <DropdownMenuContent
                align="start"
                sideOffset={10}
                className="w-[200px] rounded-xl border border-slate-200 bg-[#ffffff] px-3 pb-3 pt-2.5 shadow-2xl"
              >
                {/* Tools section */}
                <p className="mb-2.5 text-[10px] font-semibold uppercase tracking-widest text-slate-400">Tools</p>
                <div className="flex gap-1 mb-3">
                  <button
                    type="button"
                    onClick={() => { setMoreMenuOpen(false); navigate("/tools?calc=sip"); }}
                    className="group flex flex-1 flex-col items-center gap-1.5 rounded-lg px-1 py-2 transition-colors hover:bg-slate-50 active:scale-[0.97]"
                  >
                    <TrendingUp className="h-6 w-6 text-blue-600 group-hover:text-blue-700" />
                    <span className="text-center text-[10px] font-medium leading-tight text-slate-600 group-hover:text-slate-900">SIP</span>
                  </button>
                  <button
                    type="button"
                    onClick={() => { setMoreMenuOpen(false); navigate("/tools?calc=inflation"); }}
                    className="group flex flex-1 flex-col items-center gap-1.5 rounded-lg px-1 py-2 transition-colors hover:bg-slate-50 active:scale-[0.97]"
                  >
                    <Percent className="h-6 w-6 text-orange-500 group-hover:text-orange-600" />
                    <span className="text-center text-[10px] font-medium leading-tight text-slate-600 group-hover:text-slate-900">Inflation</span>
                  </button>
                  <button
                    type="button"
                    onClick={() => { setMoreMenuOpen(false); navigate("/tools?calc=tax"); }}
                    className="group flex flex-1 flex-col items-center gap-1.5 rounded-lg px-1 py-2 transition-colors hover:bg-slate-50 active:scale-[0.97]"
                  >
                    <PiggyBank className="h-6 w-6 text-rose-500 group-hover:text-rose-600" />
                    <span className="text-center text-[10px] font-medium leading-tight text-slate-600 group-hover:text-slate-900">Tax</span>
                  </button>
                </div>

                {/* Divider */}
                <div className="mb-2.5 border-t border-slate-100" />

                {/* Resources section */}
                <p className="mb-2.5 text-[10px] font-semibold uppercase tracking-widest text-slate-400">Resources</p>
                <div className="flex gap-1">
                  {/* Learn button hidden from UI per request — uncomment to restore
                  <button
                    type="button"
                    onClick={() => { setMoreMenuOpen(false); navigate("/learn"); }}
                    className="group flex flex-1 flex-col items-center gap-1.5 rounded-lg px-1 py-2 transition-colors hover:bg-slate-50 active:scale-[0.97]"
                  >
                    <BookOpen className="h-6 w-6 text-emerald-600 group-hover:text-emerald-700" />
                    <span className="text-center text-[10px] font-medium leading-tight text-slate-600 group-hover:text-slate-900">Learn</span>
                  </button>
                  */}
                  <button
                    type="button"
                    onClick={() => { setMoreMenuOpen(false); navigate("/blogs"); }}
                    className="group flex flex-1 flex-col items-center gap-1.5 rounded-lg px-1 py-2 transition-colors hover:bg-slate-50 active:scale-[0.97]"
                  >
                    <LayoutTemplate className="h-6 w-6 text-violet-500 group-hover:text-violet-600" />
                    <span className="text-center text-[10px] font-medium leading-tight text-slate-600 group-hover:text-slate-900">Blogs</span>
                  </button>
                  {/* Spacers keep Blogs in the first column, aligned below the first Tools button */}
