    ...
    },
    {
        ...
        "filters": {
            "filters": {
                ...
                "cagr_3y": {"gte": 12},
                "cagr_5y": {"gte": 12},
                "volatility_max": {"lte": 18},
                "downside_deviation_max": {"lte": 11},
            },
            "sort_field": "cagr_5y",
            "sort_order": "desc",
            "enabled_filters": [
    ...
    },
    {
        ...
        "filters": {
            "filters": {
                ...
                "cagr_3y": {"gte": 12},
                "sharpe_max": {"gte": 0.8},
                "volatility_max": {"lte": 20},
            },
            "sort_field": "sharpe_max",
            "sort_order": "desc",
            "enabled_filters": [
                "scheme_sub_category",
                "cagr_1y",
    ...
    },
    {
        ...
        "filters": {
            "filters": {
                ...
                "cagr_3y": {"gte": 6.5},
                "downside_deviation_max": {"lte": 4.5},
