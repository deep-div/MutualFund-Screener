...
const MetricCard = ({
  ...
  <div className="analytics-card analytics-metric-abs flex flex-col gap-1 px-4 py-3 items-center text-center justify-center">
                  ...
                  <div className="relative z-10 flex flex-col gap-6">
                    <div className="flex flex-col lg:flex-row lg:items-center gap-6">
                      ...
                      <div className="flex flex-col gap-1 items-start lg:items-end text-left lg:text-right">
                        ...
                        <div className="text-[22px] md:text-[26px] font-semibold text-foreground">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-[0.9fr_1.7fr] gap-6 items-stretch">
                ...
                <div className="no-cards-right bg-surface border border-border/60 rounded-2xl p-4 shadow-sm flex flex-col h-full min-h-[360px]">
                  <div className="flex items-start justify-between gap-4 mb-3">
                    ...
                    <div className="analytics-card analytics-metric-year flex flex-col gap-1 px-4 py-3 items-center text-center justify-center">
