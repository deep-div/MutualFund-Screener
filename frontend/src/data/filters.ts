...
export const FILTER_DEFINITIONS: FilterDefinition[] = [
  ...
  { id: "volatility_max", label: "Volatility Max", type: "range", category: "risk" },
  { id: "downside_deviation_max", label: "Downside Deviation Max", type: "range", category: "risk" },
  { id: "skewness_max", label: "Skewness Max", type: "range", category: "risk" },
  { id: "kurtosis_max", label: "Kurtosis Max", type: "range", category: "risk" },

  { id: "sharpe_max", label: "Sharpe Max", type: "range", category: "ratios" },
  { id: "sortino_max", label: "Sortino Max", type: "range", category: "ratios" },
  { id: "calmar_max", label: "Calmar Max", type: "range", category: "ratios" },
  { id: "pain_index_max", label: "Pain Index Max", type: "range", category: "ratios" },
  { id: "ulcer_index_max", label: "Ulcer Index Max", type: "range", category: "ratios" },
